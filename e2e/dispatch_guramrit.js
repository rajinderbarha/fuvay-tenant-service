...
(async () => {
  ...
  console.log('HAS_BK_13:', bodyText.includes('000013'));
  await page.screenshot({ path: 'C:/Users/AIVIQT~1/AppData/Local/Temp/claude/g--serviceos/a23ec8bc-eea0-4408-a4db-3f68a7a34e07/scratchpad/dispatch_guramrit.png', fullPage: true });
  await browser.close();
})();
