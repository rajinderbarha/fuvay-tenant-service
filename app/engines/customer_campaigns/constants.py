...
PLACEMENT_AFTER_PROBLEMS = "campaign_after_problems"
PLACEMENT_AFTER_SERVICES = "campaign_after_services"
PLACEMENT_MID = "campaign_mid"
PLACEMENT_AFTER_CIRCLES = "campaign_after_circles"
PLACEMENT_BOTTOM = "campaign_bottom"
CAMPAIGN_PLACEMENTS = (
    PLACEMENT_TOP, PLACEMENT_AFTER_PROBLEMS, PLACEMENT_AFTER_SERVICES,
    PLACEMENT_MID, PLACEMENT_AFTER_CIRCLES, PLACEMENT_BOTTOM,
)
