...
The bypass is scoped to Instagram and remains off unless the deployment sets
the dedicated switch.  The IP-only compose overlay enables it temporarily;
the normal domain deployment does not.
"""
