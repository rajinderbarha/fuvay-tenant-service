...
_NAV_BY_DASHBOARD_TYPE: dict[str, list[dict]] = {
    "home_services": [
        ...
        {"label": "Bookings & Jobs",      "route": "/home-services/bookings-jobs"},
        {"label": "Assignment & Dispatch","route": "/home-services/dispatch"},
        {"label": "Availability",         "route": "/home-services/availability"},
        {"label": "Customers",            "route": "/customers"},
        {"label": "Services & Pricing",   "route": "/home-services/services"},
        {"label": "Team Members",         "route": "/home-services/team"},
        {"label": "Finance & Credits",    "route": "/home-services/finance"},
        {"label": "Coverage & Hours",     "route": "/business/coverage-hours"},
        {"label": "Parts & Inventory",    "route": "/inventory"},
        {"label": "Reviews",              "route": "/home-services/reviews"},
        {"label": "Complaints",           "route": "/home-services/complaints"},
        {"label": "Refunds & Warranty",   "route": "/provider/refund-requests"},
        {"label": "Direct Payments",      "route": "/home-services/direct-payments"},
        {"label": "Reports",              "route": "/reports"},
        {"label": "Activity & Audit",     "route": "/activity"},
    ...
    "coaching": [
        ...
        {"label": "Credits",             "route": "/account/credits"},
        {"label": "Reviews",             "route": "/reviews"},
        {"label": "Analytics",           "route": "/analytics"},
        {"label": "My Offerings",        "route": "/provider/offerings"},
        {"label": "My Marketing",        "route": "/provider/marketing"},
        {"label": "Availability",        "route": "/tenant/setup/availability"},
        {"label": "Onboarding Checklist","route": "/tenant/home-services/setup"},
    ],
    "real_estate": [
        {"label": "Dashboard",           "route": "/dashboard"},
