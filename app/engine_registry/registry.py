...
def _seed_registry() -> None:
    ...
    NEW_ENGINES = [
        ...
        EngineDefinition(
            ...
            description="Step/transition-based workflow templates · evidence rules · approvals · SLA · automation triggers · versioning · runtime preview.",
            engine_type="core",
            version="1.0.0",
            dependencies=["auth", "tenant"],
            api_prefix="/v1/admin/workflow-templates",
            endpoint_count=32,
            category="operations",
            is_enabled_by_default=True,
        ),
