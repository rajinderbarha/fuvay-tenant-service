    ...
    conn.execute(sa.text("""
        ...
        BEGIN
            ...
            LOOP
                ...
                WHERE source.brand_id = source_id AND target.brand_id = target_id
                  AND source.master_service_id = target.master_service_id;
                UPDATE master_service_brands SET brand_id = target_id WHERE brand_id = source_id;

                DELETE FROM brand_category_mappings source
                USING brand_category_mappings target
                WHERE source.brand_id = source_id AND target.brand_id = target_id
                  AND source.category_id = target.category_id;
                UPDATE brand_category_mappings SET brand_id = target_id WHERE brand_id = source_id;
                ...
                UPDATE brand_service_option_mappings SET brand_id = target_id WHERE brand_id = source_id;
                ...
                WHERE source.brand_id = source_id AND target.brand_id = target_id
                  ...
                  AND source.master_service_id = target.master_service_id;
                UPDATE tenant_supported_brands SET brand_id = target_id WHERE brand_id = source_id;
                ...
                UPDATE brand_template_items SET brand_id = target_id WHERE brand_id = source_id;
                ...
                UPDATE tenant_service_brands SET brand_id = target_id WHERE brand_id = source_id;
                ...
                UPDATE brand_mappings SET brand_id = target_id WHERE brand_id = source_id;

                UPDATE brand_requests SET matched_brand_id = target_id WHERE matched_brand_id = source_id;
                UPDATE service_pricing_rules SET brand_id = target_id WHERE brand_id = source_id;
                UPDATE workflow_service_mappings SET brand_id = target_id WHERE brand_id = source_id;
                UPDATE customer_booking_drafts SET brand_id = target_id WHERE brand_id = source_id;
                UPDATE home_service_booking_drafts SET brand_id = target_id WHERE brand_id = source_id;
                UPDATE tenant_service_area_services SET brand_id = target_id WHERE brand_id = source_id;
                UPDATE usage_credit_ledger SET brand_id = target_id WHERE brand_id = source_id;

                UPDATE brands
                SET status = 'archived', is_active = false, deleted_at = now(),
                    replacement_brand_id = target_id, updated_at = now()
                WHERE id = source_id;
            END LOOP;
        END $$;
    """))
