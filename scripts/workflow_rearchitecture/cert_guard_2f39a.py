"""Slice 2F-39A worktree guard. Same pattern as prior slices' guards."""
...
EXPECTED_WORKTREE = "G:/serviceos-phase2f39a-route-census"
EXPECTED_GITDIR_SUFFIX = "worktrees/serviceos-phase2f39a-route-census"
EXPECTED_BRANCH = "security/phase-2f39a-mounted-route-census"
EXPECTED_BASE_COMMIT = "26b0109"
STATE_FILE = Path(__file__).parent / "cert_guard_2f39a_state.json"
