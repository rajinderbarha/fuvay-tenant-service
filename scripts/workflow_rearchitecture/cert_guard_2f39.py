"""Slice 2F-39 remediation guard. Same pattern as 2F-37R-A/2F-38 guards."""
...
EXPECTED_WORKTREE = "G:/serviceos-phase2f39-remediation"
EXPECTED_GITDIR_SUFFIX = "worktrees/serviceos-phase2f39-remediation"
EXPECTED_BRANCH = "security/phase-2f39-certification-remediation"
EXPECTED_BASE_COMMIT = "ba01d15"
STATE_FILE = Path(__file__).parent / "cert_guard_2f39_state.json"
