"""Slice 2F-39A2R worktree guard. Same pattern as prior slices' guards."""
...
EXPECTED_WORKTREE = "G:/serviceos-phase2f39a2r-remediation"
EXPECTED_GITDIR_SUFFIX = "worktrees/serviceos-phase2f39a2r-remediation"
EXPECTED_BRANCH = "security/phase-2f39a2r-defect-remediation"
EXPECTED_BASE_COMMIT = "fca8a96"
STATE_FILE = Path(__file__).parent / "cert_guard_2f39a2r_state.json"
