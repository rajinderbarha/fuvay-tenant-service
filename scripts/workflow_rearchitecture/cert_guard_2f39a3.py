"""Slice 2F-39A3 worktree guard. Same pattern as prior slices' guards."""
...
EXPECTED_WORKTREE = "G:/serviceos-phase2f39a3-route-census"
EXPECTED_GITDIR_SUFFIX = "worktrees/serviceos-phase2f39a3-route-census"
EXPECTED_BRANCH = "security/phase-2f39a3-route-census-tranche3"
EXPECTED_BASE_COMMIT = "293d7f5"
STATE_FILE = Path(__file__).parent / "cert_guard_2f39a3_state.json"
