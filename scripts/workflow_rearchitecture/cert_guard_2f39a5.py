"""Slice 2F-39A5 worktree guard. Same fixed pattern as cert_guard_2f39a4.py
(expected_head stored outside the committed worktree)."""
...
EXPECTED_WORKTREE = "G:/serviceos-phase2f39a5-final-decisions"
EXPECTED_GITDIR_SUFFIX = "worktrees/serviceos-phase2f39a5-final-decisions"
EXPECTED_BRANCH = "security/phase-2f39a5-final-product-decisions"
EXPECTED_BASE_COMMIT = "d960ac5"
STATE_FILE = Path("G:/serviceos-2f37r-preserve/cert_guard_2f39a5_state.json")
