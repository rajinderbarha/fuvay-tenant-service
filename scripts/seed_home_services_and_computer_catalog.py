...
HOME_SERVICES = {
    "AC & HVAC": [
        {"name": "Air Conditioner", "job_types": [
            {"key": "installation", "pricing_behavior": "range",
             "type_required": True, "types": ["Split AC", "Window AC", "Tower AC", "Cassette AC"],
             "brand_required": True, "brands": ["LG", "Samsung", "Voltas", "Daikin", "Blue Star", "Carrier", "Hitachi", "O General", "Lloyd", "Whirlpool", "Panasonic"],
             "issues": [("New AC installation", "low"), ("Install an AC moved from another location", "low")],
             "questions": [q("ac_type", "What type of AC is it?"), q("brand", "Which AC brand is it?"),
                           q("installation_location", "Where will it be installed?", options=[("bedroom", "Bedroom"), ("living_room", "Living room"), ("office", "Office"), ("other", "Other")]),
                           q("power_point_ready", "Is a dedicated power point already available?", options=[("yes", "Yes"), ("no", "No")])],
             "checklist": [("Mounting location and bracket position confirmed", "YES_NO", True), ("Indoor and outdoor units mounted securely", "YES_NO", True),
                           ("Piping, drainage and electrical connected", "YES_NO", True), ("Gas charging and pressure checked", "YES_NO", True),
                           ("Cooling and airflow tested", "YES_NO", True), ("Photo of installed unit", "PHOTO", True),
                           ("Customer sign-off", "SIGNATURE", True)]},
            {"key": "repair", "pricing_behavior": "inspection_required",
             "type_required": True, "types": ["Split AC", "Window AC", "Tower AC", "Cassette AC"],
             "brand_required": True, "brands": ["LG", "Samsung", "Voltas", "Daikin", "Blue Star", "Carrier", "Hitachi", "O General", "Lloyd", "Whirlpool", "Panasonic"],
             "issues": [("AC is not cooling", "high"), ("Water leakage", "high"), ("Unusual noise or vibration", "medium"), ("AC is not starting", "high"),
                        ("Remote or control problem", "low"), ("Bad smell from the unit", "medium"), ("Frequently turning on and off", "medium"), ("Ice formation on the unit", "medium")],
             "questions": [q("ac_type", "What type of AC is it?"), q("brand", "Which AC brand is it?"),
                           q("issue_duration", "How long has this been happening?", options=[("today", "Started today"), ("few_days", "A few days"), ("longer", "A week or more")])],
             "checklist": [("Power isolated at mains before starting", "YES_NO", True), ("Refrigerant pressure and gas level checked", "YES_NO", True),
                           ("Cooling verified with customer", "YES_NO", True), ("Photo of unit after service", "PHOTO", True),
                           ("Work area covered and protected", "CHECKBOX", True), ("Parts replaced (if any)", "SHORT_TEXT", False),
                           ("Customer sign-off", "SIGNATURE", True)]},
            {"key": "service", "pricing_behavior": "fixed",
             "type_required": True, "types": ["Split AC", "Window AC", "Tower AC", "Cassette AC"],
             "brand_required": True, "brands": ["LG", "Samsung", "Voltas", "Daikin", "Blue Star", "Carrier", "Hitachi", "O General", "Lloyd", "Whirlpool", "Panasonic"],
             "issues": [("Routine AC servicing", "low"), ("Deep cleaning", "low"), ("Seasonal performance tune-up", "low"),
                        ("Low cooling or suspected low refrigerant", "high"), ("Leak test and refrigerant refill", "high")],
             "questions": [q("ac_type", "What type of AC is it?"), q("brand", "Which AC brand is it?"),
                           q("last_service", "When was the AC last serviced?", options=[("never", "Never"), ("6m", "Within 6 months"), ("1y", "Within a year"), ("longer", "Longer than a year")]),
                           q("maintenance_goal", "What do you need from this service?", options=[("routine", "Routine servicing"), ("deep_clean", "Deep cleaning"), ("gas_refill", "Low cooling / gas refill")])],
             "checklist": [("Power isolated at mains before starting", "YES_NO", True), ("Filters and evaporator coil cleaned", "YES_NO", True),
                           ("Drain tray and drain line cleaned", "YES_NO", True), ("Electrical connections and fan checked", "YES_NO", True),
                           ("Refrigerant pressure checked, topped up if needed", "MEASUREMENT", False), ("Cooling performance verified", "YES_NO", True),
                           ("Photo of cleaned unit", "PHOTO", True), ("Customer sign-off", "SIGNATURE", True)]},
            {"key": "maintenance", "pricing_behavior": "fixed",
             "type_required": True, "types": ["Split AC", "Window AC", "Tower AC", "Cassette AC"],
             "brand_required": True, "brands": ["LG", "Samsung", "Voltas", "Daikin", "Blue Star", "Carrier", "Hitachi", "O General", "Lloyd", "Whirlpool", "Panasonic"],
             "issues": [("Annual maintenance contract visit", "low")],
             "questions": [q("ac_type", "What type of AC is it?"), q("brand", "Which AC brand is it?")],
             "checklist": [("Filters cleaned and inspected", "YES_NO", True), ("Coils and drainage checked", "YES_NO", True),
                           ("Electrical and thermostat checked", "YES_NO", True), ("Cooling performance verified", "YES_NO", True),
                           ("Customer sign-off", "SIGNATURE", True)]},
        ]},
    ],
    "Appliance Repair": [
