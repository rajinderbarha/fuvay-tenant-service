...
and `POST /v1/documents` remain `VERIFIED`. No file under
`app/engines/webhook/`, `app/engines/rag/`, `app/engines/security/`, or
`app/engines/document/` was touched this slice (all forbidden by the
frozen contract). Full `tests/test_phase2f35_critical_authorization_batch.py`
