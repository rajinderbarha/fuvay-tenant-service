...
/**
 * System/Light/Dark theme contract. Theme preference is device/user
 * presentation state, not a tenant-controlled business setting -- plain
 * AsyncStorage is correct here (contrast with SecureStore, reserved for
 * session/auth material in src/storage/secureStorage.ts).
 */
