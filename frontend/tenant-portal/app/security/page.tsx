...
export default function SecurityPage() {
  return <LegalDocument title="Security at Fuvay" updated="11 August 2026"
    intro="Fuvay uses layered controls to protect accounts, business data, and customer operations."
    sections={[
      ...
      { heading: "Report a concern", paragraphs: ["Report suspected vulnerabilities or unauthorized activity promptly to Fuvay support. Do not include sensitive customer data in the initial report."] },
    ]}/>;
}
