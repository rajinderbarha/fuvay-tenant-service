...
export default function ForgotPasswordPage() {
  ...
  async function handleRequestReset(e: React.FormEvent) {
    ...
    try {
      ...
      if (res?.otp_hint) setDevOtp(res.otp_hint); else setDevOtp("");
      setStep("reset");
    } catch (err: unknown) {
          ...
          {step === "email" && (
            <>
              ...
              <p style={{ fontSize:13, color:"var(--text-secondary)", margin:"0 0 24px", lineHeight:1.5 }}>
                Enter the email on your account and we&apos;ll send you a one-time code to reset your password.
              </p>
            ...
            <>
              ...
              {devOtp && (
                <div style={{
                  ...
                  borderRadius:10, background:"var(--golden-bg)", border:"1px solid var(--golden-border)",
                  marginBottom:18, fontSize:13, color:"var(--golden-text)",
                }}>
              ...
              <form onSubmit={handleConfirmReset} style={{ display:"flex", flexDirection:"column", gap:16 }}>
                <div>
                  ...
                  <input type="text" inputMode="numeric" maxLength={6}
                    value={otp || devOtp} onChange={e => setOtp(e.target.value.replace(/\D/g, ""))} required
                    placeholder="123456"
                ...
                <button type="button" onClick={() => { setStep("email"); setOtp(""); setDevOtp(""); setError(""); }}
