...
function BookingsJobsWorkspace() {
  ...
  return <TenantLayout activeNav="jobs"><PageShell>
    ...
    `}</style>
    <PageHeader eyebrow="Daily work" context="Operations" title="Bookings & jobs" description="A single operational view from customer booking through assignment, execution, payment and closure." actions={<div className="bj-header-actions" style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
