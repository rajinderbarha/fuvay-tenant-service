...
function WizardModal({
  ...
  function renderStep10() {
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        <div style={{ background: "var(--surface-sunken)", borderRadius: 8, padding: 16, border: "1px solid var(--border)" }}>
        ...
        {runResult && (
          <div style={{ background: "var(--success-bg)", color: "var(--success-text)", borderRadius: 8, padding: 12, border: "1px solid var(--success-border)", fontSize: 13 }}>
