...
export default function ChangePasswordRequiredPage() {
  ...
  // Redirect away if no token (not authenticated)
  useEffect(() => {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccess(true);
      // Clear tokens — user must log in again with the new password
      localStorage.removeItem("serviceos_admin_token");
      localStorage.removeItem("serviceos_admin_refresh");
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius:"var(--radius-xl, 1rem)",
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 13, color: "var(--text-secondary)", margin: 0, lineHeight: 1.5 }}>
              ...
              This may be because a temporary password was set or an administrator requested it.
            </p>
          </div>
