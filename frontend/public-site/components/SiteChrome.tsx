...
export function Header({ branding }: { branding: PlatformBranding }) {
  return <header className="header"><div className="shell nav">
    <Link className="brand" href="/"><img src={branding.brand_mark_url ?? branding.logo_light_url ?? "/brand/fuvay-logo.png"} alt={branding.brand_name} /><span>{branding.short_name}</span></Link>
